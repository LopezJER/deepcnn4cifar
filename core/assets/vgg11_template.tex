...
\pic[shift={(1.5,0,0)}] at (input-east) 
    {Box={name=conv1,caption=Conv1,xlabel={{"64",""}},ylabel=224,zlabel=224,fill=\ConvColor,height=40,width=2,depth=40}};
...
\pic[shift={(1.5,0,0)}] at (pool1-east) 
    {Box={name=conv2,caption=Conv2,xlabel={{"128",""}},ylabel=112,zlabel=112,fill=\ConvColor,height=35,width=3,depth=35}};
...
\pic[shift={(2,0,0)}] at (pool2-east) 
    {RightBandedBox={name=conv3,caption=Conv3,xlabel={{"256","256"}},ylabel=56,zlabel=56,fill=\ConvColor,bandfill=\ConvReluColor,height=30,width={4,4},depth=30}};
...
\pic[shift={(2,0,0)}] at (pool3-east) 
    {RightBandedBox={name=conv4,caption=Conv4,xlabel={{"512","512"}},ylabel=28,zlabel=28,fill=\ConvColor,bandfill=\ConvReluColor,height=23,width={7,7},depth=23}};
...
\pic[shift={(2,0,0)}] at (pool4-east) 
    {RightBandedBox={name=conv5,caption=Conv5,xlabel={{"512","512"}},ylabel=14,zlabel=14,fill=\ConvColor,bandfill=\ConvReluColor,height=15,width={7,7},depth=15}};
